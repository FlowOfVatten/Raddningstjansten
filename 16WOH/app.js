...
const EXERCISE_NAMES_HOME = {
  ...
  "armåtning hantel": "barbell bent over row",
  "liggande rodd under bord": "barbell bent over row",
...
const EXERCISE_NAMES = {
  ...
  "sittande kabelrodd smalt grepp": "cable seated row",
  "rack pull knähöjd": "rack pull",
  "unilateral hantelrodd": "barbell bent over row",
  ...
  "pec dec eller kabelfly": "dumbbell fly",
  "hammarcurl": "hammer curl",
...
function translateInstructionToSwedish(line) {
  ...
  // OBS: fraser ersätts FÖRE enstaka ord.
  // "shoulder blades" måste ersättas innan "shoulder" → "axel" ger "axel blades".
  const phraseReplacements = [
    ...
    // shoulder blades MÅSTE komma före shoulder
    ...
    ["to your starting position", "till startpositionen"],
    ["the starting position", "startpositionen"],
    ["starting position", "startpositionen"],
  ...
  // Ta bort kvarlämnande engelska artiklar och pronomen
  ...
  // Städa dubbla mellanslag och versal i början

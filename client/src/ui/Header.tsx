...
export function Header() {
  ...
  const sourceLabel = source === "trafiklab" ? "GTFS live" : source === "simulator" ? "Simulator" : "Ansluter…";

  return (
    <div ref={drag.ref as any} className="panel" style={{ minWidth: collapsed ? 220 : 280, ...drag.style }} {...drag.handlers}>
      <div style={{ display: "flex", alignItems: "flex-start", gap: 10 }}>
        <div className="title" style={{ flex: 1 }}>
          <small>Alunda Busspuls</small>
          Busstrafik i realtid
        </div>
      ...
      {!collapsed && (
        <>
          ...
          <div className="stats">
            <div className="cell"><div className="num">{stats.total}</div><div className="lbl">Bussar i trafik</div></div>
